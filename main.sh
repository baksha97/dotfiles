...
Commands:
  ...
  backup [profile]     Dump current Homebrew state to homebrew/Brewfile.<profile>
...
Examples:
  ...
  ./main.sh backup           # dump Homebrew state to homebrew/Brewfile.personal
  ./main.sh backup work      # dump Homebrew state to homebrew/Brewfile.work
