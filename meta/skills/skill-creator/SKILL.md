...
Skills live inside a parent `skills/` directory. For **dotfiles-managed global skills**, that's `meta/skills/`. For **project-specific skills**, place them under one of the conventional paths that `link-skills` auto-discovers (see "Activating Skills in a Project" below).
